	            ...
	            <div class="col-md-4 col-md-offset-4">
	                <div class="login-panel panel panel-default">
	                    ...
	                    <div class="panel-body">
	                        <form action="../controller/connexionAdmin.controller.php" method="post" onsubmit="return verifInfo()" role="form">
	                            <fieldset>
	                                <div class="form-group">
																			<label>Email : </label>
	                                    <input class="form-control" value="admin@gmail.com" placeholder="gunther@gmail.com" name="email" type="email" autofocus required>
	                                </div>
	                                <div class="form-group">
