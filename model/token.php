<?php
  ...
  function verificationToken($decoded_array){
     ...
     *Résultat: Renvoie true si le token est bien construit (c'est à dire qu'il correspond bien à celui de notre site, que le token n'est pas encore expiré, que l'id est supérieur à 0, et que le rôle soit un organisateur,joueur ou administrateur).
